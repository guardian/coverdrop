...
import { icon as createGenericJob } from "@elastic/eui/es/components/icon/assets/ml_create_generic_job";
import { icon as createGeoJob } from "@elastic/eui/es/components/icon/assets/ml_create_geo_job";
