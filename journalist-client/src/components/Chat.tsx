...
import { useErrorStore } from "../state/errors.ts";
...
export const Chat = ({
  ...
  const markCurrentChatAsUnread = () => {
    const messagesFromUser = messages.filter(
      (msg) =>
        msg.userPk === userReplyKey && msg.type === "userToJournalistMessage",
    );
    ...
    <>
      <EuiFlexGroup direction="column">
        <ChatHeader
          ...
          markAsUnread={markCurrentChatAsUnread}
        />
