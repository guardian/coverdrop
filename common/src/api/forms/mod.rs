...
mod post_journalist_to_covernode_message_deprecated;
mod post_sentinel_id_pk;
mod post_sentinel_id_pk_form;
mod post_sentinel_profile;
...
pub use post_journalist_to_covernode_message_deprecated::*;
pub use post_sentinel_id_pk::*;
pub use post_sentinel_id_pk_form::*;
pub use post_sentinel_profile::*;
